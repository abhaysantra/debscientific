                        ...
                        <div class="table_desc">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product_total"><i class="fa fa-inr" aria-hidden="true"></i> 130.00</td>
                                ...
                                <tr>
                                    ...
                                    <td class="product_quantity"><label>Quantity</label> <input min="1" max="100" value="1" type="number"></td>
                                    <td class="product_total"><i class="fa fa-inr" aria-hidden="true"></i> 180.00</td>
                                     <td class="product_remove"><a href="#"><i class="fa fa-trash-o"></i></a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="product_quantity"><label>Quantity</label> <input min="1" max="100" value="1" type="number"></td>
                                    <td class="product_total"><i class="fa fa-inr" aria-hidden="true"></i> 160.00</td>
                                    <td class="product_remove"><a href="#"><i class="fa fa-trash-o"></i></a></td>
                            ...
                            <div class="coupon_code right">
                                ...
                                <div class="coupon_inner">
                                   <div class="cart_subtotal">
                                       <p>Subtotal</p>
                                       <p class="cart_amount"><i class="fa fa-inr" aria-hidden="true"></i> 215.00</p>
                                   </div>
                                   <div class="cart_subtotal ">
                                       <p>Shipping</p>
                                       <p class="cart_amount"><span>Flat Rate:</span> <i class="fa fa-inr" aria-hidden="true"></i> 255.00</p>
                                   </div>
